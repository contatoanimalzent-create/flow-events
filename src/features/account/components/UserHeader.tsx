  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_22rem]">
      <PremiumCard className="rounded-[2.2rem] border-white/70 bg-[linear-gradient(135deg,rgba(255,255,255,0.92),rgba(248,241,232,0.84))] p-7 md:p-8">
        <div className="text-[11px] uppercase tracking-[0.32em] text-[#8e7f68]">Minha conta</div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
        <PremiumCard className="rounded-[1.8rem] p-5">
          <div className="text-[11px] uppercase tracking-[0.28em] text-[#8e7f68]">Eventos</div>
          ...
          <div className="mt-2 text-sm text-[#5f5549]">{overview.stats.upcomingEvents} futuros na sua agenda</div>
        </PremiumCard>

        <PremiumCard className="rounded-[1.8rem] p-5">
          <div className="text-[11px] uppercase tracking-[0.28em] text-[#8e7f68]">Ingressos ativos</div>
          ...
          <div className="mt-2 text-sm text-[#5f5549]">
            {overview.stats.usedTickets} ja utilizados · {formatCurrency(overview.stats.totalSpent)} em compras
          </div>
        </PremiumCard>
      </div>
    </div>
