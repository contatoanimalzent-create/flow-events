      ...
      <div className="mx-auto max-w-[1440px]">
        <PublicReveal>
          <div className="mb-10 flex flex-wrap items-end justify-between gap-6">
            ...
            <a
              href="/events"
              className="inline-flex items-center gap-2 rounded-full bg-white/[0.06] px-5 py-2.5 text-sm font-medium text-white/70 transition-all hover:bg-[#0057E7] hover:text-[#ebe7e0]"
            >
