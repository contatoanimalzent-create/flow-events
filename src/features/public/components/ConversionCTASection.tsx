            ...
            <div className="relative z-10 grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
              <div className="max-w-3xl">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/8 px-4 py-2 text-[11px] uppercase tracking-[0.3em] text-white/56">
                  ...
                  {isPortuguese ? 'Para criadores de experiencias' : 'For experience creators'}
                </div>
                <h2 className="mt-6 font-display text-[clamp(2.8rem,5vw,5.2rem)] font-semibold leading-[0.88] tracking-[-0.05em] text-white">
                  {isPortuguese
                    ? 'Seu evento, do primeiro ingresso ao ultimo credenciamento.'
                    : 'Your event, from the first ticket to the final check-in.'}
                </h2>
                <p className="mt-6 max-w-2xl text-base leading-8 text-white/72 md:text-lg">
                  {isPortuguese
                    ? 'Crie sua pagina, defina ingressos, venda online e opere com QR code. Tudo na mesma plataforma, pronto em minutos.'
                    : 'Create your page, define tickets, sell online and operate with QR code access. Everything in the same platform, ready in minutes.'}
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-3 lg:flex-col lg:items-stretch">
                ...
                >
                  {isPortuguese ? 'Explorar experiencias' : 'Explore experiences'}
