  ...
  return [
    {
      ...
      items: [
        ...
        createItem('sales', isPortuguese ? 'Vendas' : 'Sales', isPortuguese ? 'Vendas' : 'Sales',
          isPortuguese ? 'Pedidos, conversao e performance comercial.' : 'Orders, conversion and sales performance.', labels.operation, TrendingUp),
        createItem('products', isPortuguese ? 'PDV' : 'POS', isPortuguese ? 'PDV' : 'POS',
          isPortuguese ? 'Catalogo, atendimento e venda assistida.' : 'Catalog, checkout and assisted sales.', labels.operation, ShoppingBag),
        createItem('inventory', isPortuguese ? 'Estoque' : 'Inventory', isPortuguese ? 'Estoque' : 'Inventory',
          isPortuguese ? 'Saldo, reposicao e ruptura operacional.' : 'Stock, replenishment and stockout monitoring.', labels.operation, Package),
      ],
    },
    {
      key: 'people',
    ...
    },
    {
      ...
      items: [
        ...
        createItem('suppliers', isPortuguese ? 'Fornecedores' : 'Suppliers', isPortuguese ? 'Fornecedores' : 'Suppliers',
          isPortuguese ? 'Operacao terceirizada e parceiros de entrega.' : 'Third-party operations and delivery partners.', labels.business, Building2),
        createItem('sponsors', isPortuguese ? 'Patrocinadores' : 'Sponsors', isPortuguese ? 'Patrocinadores' : 'Sponsors',
          isPortuguese ? 'Cotas, ativacoes e entregas de marca.' : 'Sponsorship tiers, activations and brand deliverables.', labels.business, Crown),
