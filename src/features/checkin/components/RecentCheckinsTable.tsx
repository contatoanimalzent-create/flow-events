    ...
    <div className="reveal">
      ...
      {loading ? (
        ...
        <div className="surface-panel p-12 text-center">
          ...
          <div className="mb-1 font-display text-xl text-text-primary">Nenhum check-in recente</div>
                    ...
                    <td className="table-cell">
                      <div className="flex items-center gap-3">
                        {checkin.digital_ticket?.is_vip && (
                          <span className="rounded-full bg-brand-acid/15 px-2 py-0.5 text-[9px] font-mono uppercase tracking-[0.2em] text-brand-acid">
                            VIP
                          </span>
                        )}
                        <div>
