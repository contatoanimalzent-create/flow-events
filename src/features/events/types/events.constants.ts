...
const UNSPLASH_BANK: Record<string, string[]> = {
  'MÃºsica': ['1459749411175-04bf5292ceea', '1501386761578-eac5c94b800a', '1506157786151-b8491531f063', '1429962714451-bb934ecdc4ec', '1493225457124-a3eb161ffa5f'],
  ...
  'NegÃ³cios': ['1556761175-4b46a572b786', '1515187029135-18ee286d815b', '1542744173-8e7e53415bb0', '1521737711867-e3b97375f902', '1552664730-d307ca884978'],
  ...
  'EducaÃ§Ã£o': ['1524178232363-1fb2b075b655', '1503676260728-1c00da094a0b', '1522202176988-66273c2fd55f', '1434030216411-0b793f4b6173', '1509062522246-3755977927d7'],
...
export const EVENT_CATEGORIES = ['MÃºsica', 'Tech', 'Arte', 'Esportes', 'Business', 'Gastronomia', 'Moda', 'EducaÃ§Ã£o', 'Outro']
...
export const EVENT_STATUS_CONFIG: Record<EventStatus, EventStatusConfig> = {
  ...
  review: { label: 'Em revisÃ£o', dot: 'bg-status-warning', text: 'text-status-warning' },
