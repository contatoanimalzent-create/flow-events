  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        <div className="w-8 h-8 rounded-xl bg-gradient-teal flex items-center justify-center shrink-0">
          <Ticket className="w-4 h-4 text-bg-primary" />
        </div>
        {isOpen && (
          <div className="animate-fade-in min-w-0">
            <div className="font-bold text-text-primary text-sm leading-tight">Flow Events</div>
            <div className="text-[10px] text-text-muted truncate">{organization?.name}</div>
          </div>
        )}
      </div>
