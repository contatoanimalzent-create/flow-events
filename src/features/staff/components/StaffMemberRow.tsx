      ...
      <tr className="table-row">
        <td className="table-cell">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-bg-border bg-brand-acid/10">
        ...
        <td className="table-cell">
          ...
          <div className="text-[11px] text-text-muted">
            {[member.department, member.area, member.gate?.name].filter(Boolean).join(' · ')}
          </div>
        </td>
        <td className="table-cell">
          <select
        ...
        <td className="table-cell">
          <div className="flex items-center gap-1.5">
            ...
            <button
              onClick={onClockIn}
              className="rounded-full border border-transparent p-2 text-text-muted transition-all hover:border-status-success/20 hover:bg-status-success/8 hover:text-status-success"
            >
              <LogIn className="h-3.5 w-3.5" />
            </button>
            <button
              onClick={onClockOut}
              className="rounded-full border border-transparent p-2 text-text-muted transition-all hover:border-brand-blue/20 hover:bg-brand-blue/8 hover:text-brand-blue"
            >
            ...
            <button
              onClick={onDelete}
              className="rounded-full border border-transparent p-2 text-text-muted transition-all hover:border-status-error/20 hover:bg-status-error/8 hover:text-status-error"
            >
