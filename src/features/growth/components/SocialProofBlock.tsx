  ...
  return (
    <PublicReveal className="px-5 py-10 md:px-10 lg:px-16">
      <section className="relative mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] border border-[rgba(255,255,255,0.08)] bg-[#0e0c0a] p-8 shadow-[0_28px_80px_rgba(0,0,0,0.58)] md:p-12">
        <div className="pointer-events-none absolute right-[-4rem] top-[-4rem] h-56 w-56 rounded-full bg-[#c49a50]/05 blur-3xl" />
        ...
        <div className="relative mt-10 grid gap-5 md:grid-cols-3">
          {items.map((item, index) => (
            <div
              ...
              className="rounded-[2rem] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#c49a50]/20"
            >
