  ...
  return (
    <section className="px-5 py-10 md:px-10 lg:px-16 lg:py-14">
      <div className="mx-auto max-w-7xl">
        {title || subtitle ? (
          <PublicReveal>
            <div className="mb-10 flex flex-col gap-4 border-b border-bg-border pb-8 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                {title ? (
                  <h2 className="font-display text-[clamp(2.8rem,4vw,4.2rem)] font-semibold uppercase leading-[0.92] tracking-[-0.04em] text-text-primary">
                    {title}
                  </h2>
                ) : null}
