  ...
  return (
    <div style={{ background:'#080808',color:'#f5f5f0',overflowX:'hidden',cursor:'none',direction: isRtl ? 'rtl' : 'ltr' }}>
      ...
      <section style={{ position:'relative',minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',overflow:'hidden' }}>
        ...
        {/* TITLE */}
        <h1 style={{
          position:'relative',zIndex:10,textAlign:'center',lineHeight:0.92,margin:0,
          ...
          <span style={{ display:'block',color:'#f5f5f0' }}>{t.line1 as string}</span>
          <span style={{ display:'block',color:'#f5f5f0' }}>{t.line2 as string}</span>
          <span style={{ display:'block',color:'#d4ff00' }}>{t.line3 as string}</span>
          <span style={{ display:'block',color:'#f5f5f0' }}>{t.line4 as string}</span>
          <span style={{ display:'block',color:'#f5f5f0' }}>{t.line5 as string}<span style={{ color:'#d4ff00' }}>.</span></span>
        </h1>
        ...
        <div style={{ maxWidth:1100,margin:'0 auto' }}>
          <RevealText>
            <p style={{ fontFamily:'Bebas Neue,sans-serif',fontSize:'clamp(28px,4.5vw,60px)',letterSpacing:'-0.01em',lineHeight:1.15,color:'#f5f5f0',textAlign: isRtl ? 'right' : 'left' }}>
              {lang === 'en' && <>WHILE OTHERS GIVE YOU A <span style={{ color:'#d4ff00' }}>SELLING TOOL</span>, WE GIVE YOU A <span style={{ WebkitTextStroke:'1px #d4ff00',color:'transparent' }}>COMPLETE OPERATIONAL SYSTEM</span> FOR YOUR EVENT.</>}
              {lang === 'pt' && <>ENQUANTO OS OUTROS TE DÃO UMA <span style={{ color:'#d4ff00' }}>FERRAMENTA DE VENDA</span>, NÓS TE ENTREGAMOS UM <span style={{ WebkitTextStroke:'1px #d4ff00',color:'transparent' }}>SISTEMA OPERACIONAL COMPLETO</span> PARA SEU EVENTO.</>}
              {lang === 'es' && <>MIENTRAS OTROS TE DAN UNA <span style={{ color:'#d4ff00' }}>HERRAMIENTA DE VENTA</span>, NOSOTROS TE ENTREGAMOS UN <span style={{ WebkitTextStroke:'1px #d4ff00',color:'transparent' }}>SISTEMA OPERACIONAL COMPLETO</span> PARA TU EVENTO.</>}
              {lang === 'ar' && <>{t.statement as string}</>}
            </p>
