  ...
  return (
    <footer className="border-t border-bg-border/80 bg-[linear-gradient(180deg,rgba(244,238,229,0.74),rgba(239,230,215,0.96))]">
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-12 text-text-secondary md:px-10 lg:grid-cols-[1.15fr_0.85fr] lg:px-16 lg:py-16">
        <div>
          <div className="text-[11px] uppercase tracking-[0.34em] text-[#8e7f68]">Luxury Event Operating System</div>
          ...
          <p className="mt-5 max-w-xl text-sm leading-7 md:text-base">
            Curadoria, venda, operacao e inteligencia para experiencias que precisam parecer extraordinarias desde a descoberta ate o ultimo check-in.
          </p>
        </div>
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-3 text-sm">
              <a href="/contact" className="transition-colors hover:text-text-primary">Parcerias</a>
              <a href="/contact" className="transition-colors hover:text-text-primary">Concierge comercial</a>
              <a href="/contact" className="transition-colors hover:text-text-primary">Acesso a plataforma</a>
            </div>
          </div>
        </div>
      </div>
