  ...
  return (
    <div className="admin-page">
      ...
      <ActionConfirmationDialog
        ...
        description={pendingDeleteTicket ? t(`The type "${pendingDeleteTicket.name}" and all linked releases will be removed.`, `O tipo "${pendingDeleteTicket.name}" e todos os lotes vinculados serão removidos.`) : undefined}
      ...
      <ActionConfirmationDialog
        ...
        impact={t('Use this action only when the release should no longer exist in the commercial planning of the ticket.', 'Use está ação apenas quando o lote não deve mais existir no planejamento comercial do ingresso.')}
