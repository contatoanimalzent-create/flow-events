...
export function Topbar({ onMenuToggle, activeSection }: TopbarProps) {
  ...
  return (
    <header className="h-14 bg-bg-secondary border-b border-bg-border flex items-center px-4 gap-4 shrink-0">
      ...
      <button className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-bg-card border border-bg-border rounded-lg text-sm text-text-muted hover:border-brand-acid/30 transition-all">
